...
### Hosted Project Link
https://devipriya258.github.io/thh-placement-eval/

### Project Description
**PlacementIQ** is an AI-powered, browser-based career readiness platform that evaluates students across domain knowledge, aptitude, academics, and experience through 45+ curated questions across Technical, Engineering, and Management tracks. It delivers an instant, personalized placement readiness report with actionable recommendations — helping students identify skill gaps and walk into placements with confidence.
...
![Final screenshot](screenshot1.png)
